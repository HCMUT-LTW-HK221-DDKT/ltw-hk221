	...
	<div class="wrapper">
		...
		<div id="content" style="width: 100%">
			...
			<div class="userManage">
				<div class="d-flex search_form">
					<select id="searchBy" class="form-select">
						<option selected value="username">Tên tài khoản</option>
						<option value="email">Email</option>
						<option value="phone">Số điện thoại</option>
					</select>
					<input type="text" id="search_keyword" class="form-input" placeholder="Nhập từ khóa để tìm kiếm" name="search_keyword">
					<button class="btn btn-success" id="searchBtn" onclick="onClickSearchBtn()">Tìm kiếm</button>
				</div>
				<div id="listUser">
				</div>
			</div>
